<template>
  <div class="horizontal-scroll__wrapper">
    <div
      v-if="props.showScrollIndicators && !atStart"
      class="horizontal-scroll__indicator horizontal-scroll__indicator--left"
      @click="scrollLeft"
    >
      <div class="horizontal-scroll__arrow-icon">
        <template v-if="typeof props.leftArrowIcon === 'string'">
          <i
            :class="props.leftArrowIcon"
            :style="{
              'font-size': props.arrowIconSize + 'px',
              color: props.arrowIconColor,
            }"
          ></i>
        </template>
        <template v-else>
          <component
            :is="props.leftArrowIcon"
            class="horizontal-scroll__arrow-icon"
          ></component>
        </template>
      </div>
    </div>
    ...
    <div
      v-if="props.showScrollIndicators && !atEnd"
      class="horizontal-scroll__indicator horizontal-scroll__indicator--right"
      @click="scrollRight"
    >
      <div class="horizontal-scroll__arrow-icon">
        <template v-if="typeof props.rightArrowIcon === 'string'">
          <i
            :class="props.rightArrowIcon"
            :style="{
              'font-size': props.arrowIconSize + 'px',
              color: props.arrowIconColor,
            }"
